...
class TestExtractAnswer:
    ...
    def test_qa1_simple_match(self, qa1):
        ...
        assert (
            qa1.extract_answer("The most recent location of Mary is kitchen.", sample)
            == "kitchen"
        )
    ...
    def test_extract_takes_first_sentence_only(self, qa1):
        ...
        out = qa1.extract_answer(
            "Mary is in the kitchen. Then she went to the bedroom.", sample
        )
        assert out == "kitchen"
    ...
    def test_extract_strips_hallucinated_examples(self, qa1):
        sample = {"question": "Where is Mary?", "target": "kitchen"}
        out = qa1.extract_answer(
            "kitchen <example>Mary is in the bedroom</example>", sample
        )
